...
c      call unimem_malloc(ptr_colidx, sizeof(colidx), 0)
      call unimem_malloc(ptr_colidx, sizeof(colidx), data_pos)
...
c      print *,"1: ", loc(a)
c      print *,"1: ", ptr_a
c      call unimem_malloc(ptr_a, sizeof(a), 0)
      call unimem_malloc(ptr_a, sizeof(a), data_pos)
c      print *,"2: ", loc(a)
c      print *,"2: ", ptr_a

c      print *, "a:", sizeof(a)
      call unimem_malloc(ptr_x, sizeof(x), data_pos)      
c      call unimem_malloc(ptr_z, sizeof(z), 0)
      call unimem_malloc(ptr_z, sizeof(z), data_pos)
c      print *, "z:", sizeof(z)
c      call unimem_malloc(ptr_p, sizeof(p), 0)
      call unimem_malloc(ptr_p, sizeof(p), data_pos)
c      print *, "p:", sizeof(p)
c      call unimem_malloc(ptr_q, sizeof(q), 0)
      call unimem_malloc(ptr_q, sizeof(q), data_pos)
c      print *, "q:", sizeof(q)
c      call unimem_malloc(ptr_r, sizeof(r), 0)
      call unimem_malloc(ptr_r, sizeof(r), data_pos)
c      print *, "r:", sizeof(r)
c      call unimem_malloc(ptr_w, sizeof(w), 0)
...
c-------------------------------------------------------------------
c      print*, "colidx: add:",loc(colidx),"size:",sizeof(colidx)
c      print*, "a: add:",loc(a),"size:",sizeof(a)
c      print*, "w: add:",loc(w),"size:",sizeof(w)
c      print*, "z: add:",loc(z),"size:",sizeof(z)
c      print*, "p: add:",loc(p),"size:",sizeof(p)
c      print*, "r: add:",loc(r),"size:",sizeof(r)
c      print*, "q: add:",loc(q),"size:",sizeof(q)
c---------------------------------------------------------------------                                                                            
...
c         print *, "1111111loc(colidx): ", loc(colidx)
c         print *, "1111111ptr_colidx: ", ptr_colidx
c         print *, "sizeof(colidx)", sizeof(colidx)
c         print *, "sizeof(p)", sizeof(p)
c         if (cgit .eq. 1) then
c            if (main_loop .eq . 1) then 
c               call move_test(ptr_colidx, sizeof(colidx))
c                call move_test(ptr_p, sizeof(p))
c           end if 
c        end if
c         CALL end_one_iteration(main_loop)
c     >                          ptr_colidx, ptr_a, ptr_w, ptr_z,
c     >                          ptr_p, ptr_q, ptr_r)
c         print *, "2222222loc(colidx): ", loc(colidx)
c         print *, "2222222ptr_colidx: ", ptr_colidx
