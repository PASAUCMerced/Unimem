...
c---------------------------------------------------------------------------c
      ...
      pointer(ptr_t, t)
      pointer(ptr_t0, t0)
      pointer(ptr_tinit, tinit)
      pointer(ptr_mflops, mflops)
c      pointer(ptr_timer_read, timer_read)
c---------------------------------------------------------------------------c
...
c---------------------------------------------------------------------------c
      ...
      common /noautom/ ptr_u,ptr_v,ptr_r   

      double precision rnm2, rnmu, old2, oldu, epsilon
      pointer(ptr_rnm2, rnm2)
      pointer(ptr_rnmu, rnmu)
      pointer(ptr_old2, old2)
      pointer(ptr_oldu, oldu)
      ...
      pointer(ptr_nn, nn)
      pointer(ptr_verify_value, verify_value)
      pointer(ptr_err, err)
...
c----------------------------kai--------------------------------------------
      ...
      call unimem_malloc(ptr_nm, sizeof(nm), data_pos)
      call unimem_malloc(ptr_nv, sizeof(nv), data_pos)
      call unimem_malloc(ptr_nr, sizeof(nr), data_pos)
      call unimem_malloc(ptr_nm2, sizeof(nm2), data_pos)
      call unimem_malloc(ptr_maxlevel, sizeof(maxlevel), data_pos)
      call unimem_malloc(ptr_maxprocs, sizeof(maxprocs), data_pos)
      
      call unimem_malloc(ptr_nbr, sizeof(nbr), data_pos)
      call unimem_malloc(ptr_msg_type, sizeof(msg_type), data_pos)
      ...
      call unimem_malloc(ptr_debug_vec, sizeof(debug_vec), data_pos)

      call unimem_malloc(ptr_ir, sizeof(ir), data_pos)
      call unimem_malloc(ptr_m1, sizeof(m1), data_pos)
      call unimem_malloc(ptr_m2, sizeof(m2), data_pos)
      call unimem_malloc(ptr_m3, sizeof(m3), data_pos)

      call unimem_malloc(ptr_lt, sizeof(lt), data_pos)
      call unimem_malloc(ptr_lb, sizeof(lb), data_pos)
      
      call unimem_malloc(ptr_dead, sizeof(dead), data_pos)
      call unimem_malloc(ptr_give_ex, sizeof(give_ex), data_pos)
      call unimem_malloc(ptr_take_ex, sizeof(take_ex), data_pos)

      call unimem_malloc(ptr_m, sizeof(m), data_pos)
      call unimem_malloc(ptr_buff, sizeof(buff), data_pos)

      call unimem_malloc(ptr_t_bench, sizeof(t_bench), data_pos)
      call unimem_malloc(ptr_t_init, sizeof(t_init), data_pos)
      call unimem_malloc(ptr_t_psinv, sizeof(t_psinv), data_pos)
      call unimem_malloc(ptr_t_resid, sizeof(t_resid), data_pos)
      call unimem_malloc(ptr_t_rprj3, sizeof(t_rprj3), data_pos)
      call unimem_malloc(ptr_t_interp, sizeof(t_interp), data_pos)
      call unimem_malloc(ptr_t_norm2u3, sizeof(t_norm2u3), data_pos)
      call unimem_malloc(ptr_t_comm3, sizeof(t_comm3), data_pos)
      call unimem_malloc(ptr_t_rcomm, sizeof(t_rcomm), data_pos)
      ...
      call unimem_malloc(ptr_t0, sizeof(t0), data_pos)
      call unimem_malloc(ptr_tinit, sizeof(tinit), data_pos)
      call unimem_malloc(ptr_mflops, sizeof(mflops), data_pos)
c      call unimem_malloc(ptr_timer_read, sizeof(timer_read), data_pos)
      ...
      call unimem_malloc(ptr_rnm2, sizeof(rnm2), data_pos)
      call unimem_malloc(ptr_rnmu, sizeof(rnmu), data_pos)
      call unimem_malloc(ptr_old2, sizeof(old2), data_pos)
      call unimem_malloc(ptr_oldu, sizeof(oldu), data_pos)
      call unimem_malloc(ptr_epsilon, sizeof(epsilon), data_pos)

      call unimem_malloc(ptr_n1, sizeof(n1), data_pos)
      call unimem_malloc(ptr_n2, sizeof(n2), data_pos)
      call unimem_malloc(ptr_n3, sizeof(n3), data_pos)
      call unimem_malloc(ptr_nit, sizeof(nit), data_pos)

      call unimem_malloc(ptr_nn, sizeof(nn), data_pos)
      call unimem_malloc(ptr_verify_value, sizeof(verify_value), 
     >                   data_pos)
      ...
      print *,"sizeof(nbr)", sizeof(nbr)
      print *,"sizeof(msg_type)", sizeof(msg_type)
      print *,"sizeof(msg_id)", sizeof(msg_id)
      print *,"sizeof(ir)", sizeof(ir)
      print *,"sizeof(m1)", sizeof(m1)
      print *,"sizeof(m2)", sizeof(m2)
      print *,"sizeof(m3)", sizeof(m3)
      print *,"sizeof(buff)", sizeof(buff)
      print *,"sizeof(u)", sizeof(u)
      print *,"sizeof(v)", sizeof(v)
      print *,"sizeof(r)", sizeof(r)

c      call unimem_init_mg(ptr_buff, loc(buff), sizeof(buff),
c     >                    ptr_u, loc(u), sizeof(u),
c     >                    ptr_v, loc(v), sizeof(v),
