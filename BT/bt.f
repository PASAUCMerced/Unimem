...
c--------------------------------kai----------------------------------
     ...
     >                    data_pos)
       ...
       call unimem_malloc(ptr_forcing, sizeof(forcing), data_pos)
       call unimem_malloc(ptr_u, sizeof(u), data_pos)
       call unimem_malloc(ptr_rhs, sizeof(rhs), data_pos)
     ...
     >                   data_pos)
      ...
      print *, "sizeof(backsub_info)", sizeof(backsub_info)
      print *, "sizeof(cv)", sizeof(cv)
      print *, "sizeof(rhon)", sizeof(rhon)
      print *, "sizeof(rhos)", sizeof(rhos)
      print *, "sizeof(rhoq)", sizeof(rhoq)
      print *, "sizeof(cuf)", sizeof(cuf)
      print *, "sizeof(q)", sizeof(q)
      print *, "sizeof(ue)", sizeof(ue)
