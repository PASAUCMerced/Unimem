...
c---------------------------------kai--------------------------------
     ...
     >                   data_pos)
      ...
      call unimem_malloc(ptr_rsd, sizeof(rsd), data_pos)
      call unimem_malloc(ptr_frct, sizeof(frct), data_pos)
      call unimem_malloc(ptr_flux, sizeof(flux), data_pos)
      ...
      call unimem_malloc(ptr_b, sizeof(b), data_pos)
      call unimem_malloc(ptr_c, sizeof(c), data_pos)
      call unimem_malloc(ptr_d, sizeof(d), data_pos)
      ...
      call unimem_malloc(ptr_buf1, sizeof(buf1), data_pos)
