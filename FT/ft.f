...
c---------------------------------------------------------------------
      ...
      pointer(ptr_pad1, pad1)
      pointer(ptr_pad2, pad2)
      pointer(ptr_pad3, pad3)
     ...
     >             ptr_twiddle
      ...
      logical verified
      character class
      pointer(ptr_iter, iter)
      pointer(ptr_total_time, total_time)
...
c      call unimem_malloc(ptr_np, sizeof(np), data_pos)

      call unimem_malloc(ptr_layout_0D, sizeof(layout_0D), data_pos)
      call unimem_malloc(ptr_layout_1D, sizeof(layout_1D), data_pos)
      call unimem_malloc(ptr_layout_2D, sizeof(layout_2D), data_pos)

      call unimem_malloc(ptr_fftblock_default, sizeof(fftblock_default),
     >                   data_pos)
      call unimem_malloc(ptr_fftblockpad_default,
     >                   sizeof(fftblockpad_default), data_pos)
      call unimem_malloc(ptr_transblock, sizeof(transblock), data_pos)
      call unimem_malloc(ptr_transblockpad, sizeof(transblockpad),
     >                   data_pos)

      call unimem_malloc(ptr_fftblock, sizeof(fftblock), data_pos)

      call unimem_malloc(ptr_me, sizeof(me), data_pos)
      call unimem_malloc(ptr_me1, sizeof(me1), data_pos)
      call unimem_malloc(ptr_me2, sizeof(me2), data_pos)

      call unimem_malloc(ptr_commslice1, sizeof(commslice1), data_pos)
      call unimem_malloc(ptr_commslice2, sizeof(commslice2), data_pos)

      call unimem_malloc(ptr_dims, sizeof(dims), data_pos)

      call unimem_malloc(ptr_xstart, sizeof(xstart), data_pos)
      call unimem_malloc(ptr_ystart, sizeof(ystart), data_pos)
      call unimem_malloc(ptr_zstart, sizeof(zstart), data_pos)
      call unimem_malloc(ptr_xend, sizeof(xend), data_pos)
      call unimem_malloc(ptr_yend, sizeof(yend), data_pos)
      call unimem_malloc(ptr_zend, sizeof(zend), data_pos)


      call unimem_malloc(ptr_T_toal, sizeof(T_total), data_pos)
      call unimem_malloc(ptr_T_setup, sizeof(T_setup), data_pos)
      call unimem_malloc(ptr_T_fft, sizeof(T_fft), data_pos)
      call unimem_malloc(ptr_T_evolve, sizeof(T_evolve), data_pos)
      call unimem_malloc(ptr_T_checksum, sizeof(T_checksum), data_pos)
      call unimem_malloc(ptr_T_fftlow, sizeof(T_fftlow), data_pos)
      call unimem_malloc(ptr_T_fftcopy, sizeof(T_fftcopy), data_pos)
      call unimem_malloc(ptr_T_transpose, sizeof(T_transpose),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxzloc, sizeof(T_transxzloc),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxzglo, sizeof(T_transxzglo),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxzfin, sizeof(T_transxzfin),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxyloc, sizeof(T_transxyloc),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxyglo, sizeof(T_transxyglo),
     >                   data_pos)
      call unimem_malloc(ptr_T_transxyfin, sizeof(T_transxyfin),
     >                   data_pos)
      call unimem_malloc(ptr_T_synch, sizeof(T_synch), data_pos)
      call unimem_malloc(ptr_T_init, sizeof(T_init), data_pos)
      call unimem_malloc(ptr_T_max, sizeof(T_max), data_pos)

      call unimem_malloc(ptr_timers_enabled, sizeof(timers_enabled),
     >                   data_pos)
      call unimem_malloc(ptr_debug, sizeof(debug),
     >                   data_pos)
      call unimem_malloc(ptr_debugsynch, sizeof(debugsynch),
     >                   data_pos)

      call unimem_malloc(ptr_seed, sizeof(seed), data_pos)
      call unimem_malloc(ptr_a, sizeof(a), data_pos)
      call unimem_malloc(ptr_pi, sizeof(pi), data_pos)
      call unimem_malloc(ptr_alpha, sizeof(alpha), data_pos)

      call unimem_malloc(ptr_u, sizeof(u), data_pos)
      call unimem_malloc(ptr_sums, sizeof(sums), data_pos)
      ...
      call unimem_malloc(ptr_twiddle, sizeof(twiddle), data_pos)
      call unimem_malloc(ptr_pad1, sizeof(pad1), data_pos)
      call unimem_malloc(ptr_pad2, sizeof(pad2), data_pos)
      call unimem_malloc(ptr_pad3, sizeof(pad3), data_pos)

      call unimem_malloc(ptr_iter, sizeof(iter), data_pos)
      call unimem_malloc(ptr_total_time, sizeof(total_time), data_pos)
